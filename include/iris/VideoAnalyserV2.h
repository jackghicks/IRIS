...
/////////////////////////////////////////////////////////////////////////////
// VideoAnalyserV2 is the main object to with which to run a photosensitivity
...
// deinitialization is managed by VideoAnalyserV2.
...
namespace iris
{
	...
	class VideoAnalyserV2
	{
	public:
		VideoAnalyserV2(Configuration* configuration, irisProgressCallback* callback);
		~VideoAnalyserV2();
	...
	private:
		...
		irisProgressCallback* m_callback;
	};
}
